    ...
    <section className='flex flex-col p-4 rounded-md gap-5 sm:flex-row-reverse sm:relative' style={{backgroundColor:'var(--white)'}}>
                        ...
                        <section className='flex flex-col gap-4'>
                            ...
                            <section className='flex gap-5 items-center'>
                              <img src={userList.some(u=>u.username===c.user.username)?c.user.image.png:imageuser} alt={userList.some(u=>u.username===c.user.username)?c.user.username:'Deleted account'} className='w-10 h-10'/>
